    ...
    <section className="section" id="pricing">
      ...
      <div className="pricing-grid">
        <div className="price-card">
          ...
          <a className="btn btn-ghost" href="https://calendly.com/robotbobby/consult" target="_blank" rel="noreferrer">Book</a>
        </div>
        <div className="price-card featured">
          ...
          <a className="btn btn-primary" href="https://calendly.com/robotbobby/consult" target="_blank" rel="noreferrer">Book</a>
        </div>
        <div className="price-card">
          <h4>Skill Sprint</h4>
